...
selectVoice:"%1 voices available, use the up and down arrows to select a voice, enter when you're done.",
	...
	achhfaillast:"Fail (no safeguards) at the last level of a pack.",
		...
		this.strings[2] = {
			...
			missionlevels: "Completando niveles. Nivel de misión %1, %2 niveles de %3",
			...
			missionwins: "Compórtate como un ganador: Nivel de misión %1, con %2 de %3 veces que has ganado",
			sTotalSafeguards: "Has usado %1 antifallos en total",
			sTotalFails: "Has fallado %1 veces",
			missiontfails: "Fallar puede ser bueno",
			missionfails: "Fallar puede ser bueno: Nivel %1, con %2 de %3 fallos",
			...
			missioncash: "Llueven moneditas: Nivel %1, con %2 de %3 monedas para el siguiente nivel",
